...
IFontDisp = Font
__all__ = [ 'OLE_OPTEXCLUSIVE', 'FONTSTRIKETHROUGH', 'OLE_HANDLE',
           'OLE_XSIZE_CONTAINER', 'OLE_YPOS_PIXELS',
           'OLE_XSIZE_PIXELS', 'FONTITALIC', 'FONTSIZE',
           'IPictureDisp', 'OLE_YSIZE_PIXELS', 'Default',
           'StdPicture', 'LoadPictureConstants', 'Checked',
           'OLE_COLOR', 'Unchecked', 'IFontDisp', 'FONTUNDERSCORE',
           'FONTNAME', 'OLE_XPOS_HIMETRIC', 'OLE_YPOS_HIMETRIC',
           'Picture', 'OLE_XPOS_PIXELS', 'IPicture', 'FONTBOLD',
           'OLE_YPOS_CONTAINER', 'OLE_XPOS_CONTAINER',
           'OLE_CANCELBOOL', 'OLE_TRISTATE', 'OLE_YSIZE_CONTAINER',
           'OLE_XSIZE_HIMETRIC', 'VgaColor', 'Gray', 'StdFont',
           'IFontEventsDisp', 'OLE_YSIZE_HIMETRIC', 'Font',
           'OLE_ENABLEDEFAULTBOOL', 'Color', 'Monochrome', 'IFont',
           'FontEvents']
